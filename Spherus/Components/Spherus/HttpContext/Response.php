<?php
	...
	*/
    ...
    class Response
    {
         ...
         *            The controller to redirect to. If null, then current
         *            controller will be used
         * @param string $module
         *            The module to redirect to. If null, then current module
         *            will be used
         ...
         *            The time in seconds to cache expiration
         * @throws SpherusException When $expireSeconds is null or empty, or is
