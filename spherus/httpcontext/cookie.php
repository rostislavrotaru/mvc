	...
	namespace Spherus\HttpContext
	{
		...
		*/
		class Cookie
		{
			...
			/**
			 * Indicates that the cookie will be accessible only through the HTTP protocol <br /> 
			 ...
			 * 
			 * @param string $domain The Cookie domain name to set
			 */
			 ...
			 * @param int $expires Number of seconds
			 */
			 ...
			 * Indicates that the cookie should only be transmitted over a secure HTTPS connection from the client
			 * 
			 * @param boolean $secure The Cookie secure parameter
			 */
			...
			/**
			 * Gets that the cookie will be accessible only through the HTTP protocol <br /> 
			 * If is set to true, cookie won't be accessible by scripting languages
			 *
			 * @return boolean
			 */
			...
			/**
			 * Sets if the cookie should be accessible only through the HTTP protocol <br /> 
			 * If is set to true, cookie won't be accessible by scripting languages
			 *
			 * @param boolean The Cookie HttpOnly paramater
			 */
