...
namespace Spherus\Core
{
    ...
    class Check
    {
        ...
        public static function FileExists ($fileName)
        {
            if (! file_exists($fileName)) {
                throw new SpherusException(
                        sprintf(EXCEPTION_FILE_NOT_EXISTS, $fileName));
            }
        }
        ...
        public static function IsObject ($object)
        {
            ...
            if (! (is_object($object))) {
                throw new SpherusException(
                        sprintf(EXCEPTION_NOT_OBJECT, get_class($object)));
            }
        }
         ...
         *            The instance of class to compare.
         *            
        ...
        public static function IsInstanceOf ($object, $instance)
        {
            ...
            switch (true) {
                ...
                default:
                    throw new SpherusException(
                            sprintf(EXCEPTION_OBJECT_INVALID_INSTANCE, 
