...
namespace Spherus\Core
{
    ...
    class SpherusException extends \Exception
    {
         ...
         * @param strinf $code
         *            The exception code
         * @param Exception $internalException
    ...
    define('EXCEPTION_INVALID_ROUTER_CONFIG', 
            'Invalid configuration for router definition');
    ...
    define('EXCEPTION_FILE_NOT_READABLE', 
            'The "%s" file is not readable. Please check file system permissions');
    ...
    define('EXCEPTION_DUPLICATE_ROUTE', 
            'The route "%s" already exists and cannot be registsred.');
    define('EXCEPTION_INVALID_INTEGER', 
            'Given value is not a valid integer value');
    define('EXCEPTION_DUPLICATE_MODULE', 
            'An module with the same name already exists');
    define('EXCEPTION_APP_CONFIG_NOT_FOUND', 
            'The application configuration file not found');
    define('EXCEPTION_NO_CONTROLLER_ACTION_METHOD', 
            'The function "%s" does not exists in controller "%s" in module "%s"');
    define('EXCEPTION_OBJECT_INVALID_INSTANCE', 
            'The "%s" object is not a valid instance of "%s"');
